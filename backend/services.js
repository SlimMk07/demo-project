...
MongoClient.connect(mongourl, { useNewUrlParser: true }, (err, client) => {
  ...
  /** professors managing */
  app.delete('/delete_professor/:id', cors(), (req, res) => {
  ...
  app.get('/professors', cors(), (req, res) => {
  ...
  app.get('/professors/:id', cors(), (req, res) => {
    let ID = ObjectID(req.params.id)
...
/** Classes */
app.delete('/delete_classes/:id', cors(), (req, res) => {
  let ID = ObjectID(req.params.id)
...
app.get('/classes/:id', cors(), (req, res) => {
  let ID = ObjectID(req.params.id)
